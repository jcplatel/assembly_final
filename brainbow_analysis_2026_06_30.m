...
for file_num = files_to_process
 ...
 [Tr1b,speedsm,Raster,SumAct,MAct,Race,RasterRace,WinRest, WinActive,...
    ...
    for nanalysis=NClinit%4:20%[12 ,15, 17, 18]%:5
        ...
        % SCE_clustering
        [IDX2, NClOK, assemblyortho, assemblystat, mean_sClOK, mean_Event_Purity, mean_Cellular_Fidelity, AmpTable] = ...
    run_kmeans_consensus(Race, TRace, DFF0, Raster, NClini, kmean_iter, kmeans_surrogate, kmeans_rnd_iter, x1, RList, savefig, namefull);
