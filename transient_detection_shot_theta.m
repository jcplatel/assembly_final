...
for i=1:NCell     
    noise= 1.4826 * mad(diff(DFF0(i, WinRest)),1)/ sqrt(2);%0 for mean absolute deviation 1 for median
    th_detection(i)= threshold_peak * noise ;%default=2.33
    ...
    % % Seuil de Burst : par exemple, Médiane + 2 IQR 
